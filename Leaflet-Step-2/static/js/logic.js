...
function createMap(earthquakes) {
  ...
  var overlayMaps = {
    ...
    TectonicPlates: tecLines
  };

  // Create our map, giving it the streetmap, earthquakes and tecLines layers to display on load
  var myMap = L.map("map", {
    center: [
      37.09, -95.71
    ],
    zoom: 5,
    layers: [streetmap, earthquakes, tecLines]
  });
...
d3.json("https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json", function(pdata) {
  L.geoJSON(pdata, {
         color: "blue",
         weight: 3
  })
  .addTo(tecLines);
  tecLines.addTo(myMap);
   });
